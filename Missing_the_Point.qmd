...
```{r}
# Load in a single variable of interest

# Create histogram of the variable before imputing

# Impute that variable using the median or mean

# Create histogram of the variable after imputing
